                ...
                <div class="row justify-content-center">
                        ...
                        <div class="col-12 blog-post-content border-radius-6px overflow-hidden text-center p-0 margin-4-half-rem-bottom wow animate__fadeIn">
                            ...
                            <div class="blog-text d-inline-block w-100">
                                <div class="content margin-40px-top  lg-padding-4-half-rem-all xs-padding-20px-lr xs-padding-40px-tb position-relative mx-auto w-100 lg-w-100">
                                    <h6 class="alt-font3 font-weight-700 text-dark text-left"><?php echo $blog->name ?></h6>
                                    <div class="alt-font3">
                                        <?php echo $blog->body ?>
                                    </div>
                    ...
                    <aside class="col-12 col-xl-3 offset-xl-1 col-lg-4 col-md-7 col-sm-6 blog-sidebar lg-padding-4-rem-left md-padding-15px-left">
                        <div class="d-inline-block w-100 ">
                            <span class="alt-font3 font-weight-700 text-large text-extra-dark-gray d-block margin-25px-bottom">OTRAS NOTAS</span>
                        ...
                        <div class=" border-radius-4px text-center margin-5-rem-bottom xs-margin-35px-bottom text-left">
                            ...
                            <a href="blog-grid.html" class="text-extra-dark-gray alt-font3 font-weight-700 margin-20px-top d-inline-block text-medium text-dark"><?php echo $blog_aleatorio->name ?></a>
                            <p class="alt-font3 text-dark"><?php echo $blog_aleatorio->description ?></p>
                            <div class="d-flex align-items-center">
                                <span class="alt-font3 me-auto"><a href="single_blog.php?id=<?php echo $blog_aleatorio->id ?>" class="text-dark">Leer más</a></span>
                            </div>
                        </div>
                        <?php endif ?>
